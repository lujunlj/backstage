package com.tencent.backstage.config.codecreate;
...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/backstage?serverTimezone=Asia/Shanghai&characterEncoding=utf8&useSSL=false");
        ...
        pc.setParent("com.tencent.backstage.modules");
...
//      strategy.setSuperEntityClass("com.tencent.common.mpbase.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
//      strategy.setSuperControllerClass("com.tencent.common.mpbase.BaseController");
